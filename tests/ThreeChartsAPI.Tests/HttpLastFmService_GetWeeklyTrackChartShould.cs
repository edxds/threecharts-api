...
{
    public class HttpLastFmService_GetWeeklyTrackChartShould
    {
        [Fact]
        public async Task GetWeeklyTrackChart_CallsHttpClientCorrectly()
        {
            ...
            deserializerMock.Setup(d => d.DeserializeTrackChart(It.IsAny<Stream>()))
        ...
        [Fact]
        public async Task GetWeeklyTrackChart_HandlesKnownErrorsCorrectly()
        {
            var baseUri = "http://ws.audioscrobbler.com/2.0/";
            ...
            var result = await service.GetWeeklyTrackChart("edxds", 0, 0);
        ...
        [Fact]
        public async Task GetWeeklyTrackChart_HandlesUnknownErrorsCorrectly()
        {
            var baseUri = "http://ws.audioscrobbler.com/2.0/";
